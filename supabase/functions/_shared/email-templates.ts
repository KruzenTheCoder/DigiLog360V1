// ============================================================================
// Task email alerts — COPY of packages/shared/src/emailAlerts.ts for Deno.
//
// Edge functions can't import the npm workspace package, so this file is a
// synced copy of the canonical module. DO NOT edit here — edit
// packages/shared/src/emailAlerts.ts and re-copy (only this header differs).
// ============================================================================
